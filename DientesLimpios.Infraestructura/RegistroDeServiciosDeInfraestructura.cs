...
namespace DientesLimpios.Infraestructura
{
    public static class RegistroDeServiciosDeInfraestructura
    {
        ...
        {
            services.AddScoped<IServicioNotificaciones, ServicioCorreos>(); // Registro del servicio de notificaciones
            return services; // Retornar la colección de servicios para encadenamiento
        }
    }
}
